...
- Before making a commit or when encountering any CI issues run the linter and tests to ensure
  everything is working correctly. Use `./scripts/run-all-checks` to run all checks at once.
