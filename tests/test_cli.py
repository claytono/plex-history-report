...
class TestCLIParser(unittest.TestCase):
    ...
    def test_partially_watched_filtering(self):
        ...
        with patch('plex_history_report.cli.load_config', return_value={'plex': {'base_url': 'test', 'token': 'test'}}), \
            ...
            filtered_movies = [movie for movie in mock_movies if 0 < movie['completion_percentage'] < 100]
    ...
    def test_partially_watched_tv_filtering(self):
        ...
        with patch('plex_history_report.cli.load_config', return_value={'plex': {'base_url': 'test', 'token': 'test'}}), \
            ...
            filtered_shows = [show for show in mock_shows if 0 < show['completion_percentage'] < 100]
    ...
    def test_edge_cases_filtering(self):
        ...
        mock_shows = [
            ...
            {'title': 'Negative Percentage', 'completion_percentage': -5},  # Invalid but should be handled
            {'title': 'Over 100 Percentage', 'completion_percentage': 105},  # Invalid but should be handled
