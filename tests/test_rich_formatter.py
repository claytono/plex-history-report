...
class TestRichFormatter(unittest.TestCase):
    ...
    def test_format_recently_watched_shows(self):
        ...
        result = self.formatter.format_recently_watched(self.recently_watched_shows, media_type="show")
    ...
    def test_format_recently_watched_movies(self):
        ...
        result = self.formatter.format_recently_watched(self.recently_watched_movies, media_type="movie")
    ...
    def test_format_movie_summary(self):
        ...
        # Test Movie 1: 120 minutes × 2 watches = 240 minutes
        # Test Movie 3: 45 minutes × 3 watches = 135 minutes
